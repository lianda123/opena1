# WoodSheetLayout 2.1.1（Rhino 7 / Rhino 8）
...
普通 `WoodSheetLayout` 遇到折弯件时自动跳过，不进行中性层计算。折弯件单独运行 `WSLayFlatBend`：
...
- `WoodSheetLayout-2.1.1-rhino7.zip`
- `WoodSheetLayout-2.1.1-rhino8.zip`
- `WoodSheetLayout-2.1.1-rhino7-rhino8.zip`
